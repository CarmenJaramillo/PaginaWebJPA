...
public class FacturaJpaController implements Serializable {
    ...
    public void create(Factura factura) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            Plancliente idNoPlan = factura.getIdNoPlan();
            if (idNoPlan != null) {
                idNoPlan = em.getReference(idNoPlan.getClass(), idNoPlan.getIdNoPlan());
                factura.setIdNoPlan(idNoPlan);
            }
            ...
            if (idNoPlan != null) {
                idNoPlan.getFacturaList().add(factura);
    ...
    public void edit(Factura factura) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Plancliente idNoPlanOld = persistentFactura.getIdNoPlan();
            Plancliente idNoPlanNew = factura.getIdNoPlan();
            ...
            if (idNoPlanNew != null) {
                ...
                factura.setIdNoPlan(idNoPlanNew);
            }
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Plancliente idNoPlan = factura.getIdNoPlan();
            if (idNoPlan != null) {
                idNoPlan.getFacturaList().remove(factura);
                idNoPlan = em.merge(idNoPlan);
            }
            em.remove(factura);
            utx.commit();
