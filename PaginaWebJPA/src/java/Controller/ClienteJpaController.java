...
public class ClienteJpaController implements Serializable {
    ...
    public void create(Cliente cliente) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            if (idRol != null) {
                idRol.getClienteList().add(cliente);
    ...
    public void edit(Cliente cliente) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Rol idRolOld = persistentCliente.getIdRol();
            Rol idRolNew = cliente.getIdRol();
            ...
            if (idRolOld != null && !idRolOld.equals(idRolNew)) {
                idRolOld.getClienteList().remove(cliente);
                idRolOld = em.merge(idRolOld);
            }
            if (idRolNew != null && !idRolNew.equals(idRolOld)) {
                idRolNew.getClienteList().add(cliente);
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Rol idRol = cliente.getIdRol();
            if (idRol != null) {
                idRol.getClienteList().remove(cliente);
                idRol = em.merge(idRol);
            }
            em.remove(cliente);
            utx.commit();
