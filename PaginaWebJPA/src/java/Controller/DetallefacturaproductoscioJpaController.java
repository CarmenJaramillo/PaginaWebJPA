...
public class DetallefacturaproductoscioJpaController implements Serializable {
    ...
    public void create(Detallefacturaproductoscio detallefacturaproductoscio) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findDetallefacturaproductoscio(detallefacturaproductoscio.getIdDetalleFacturaProductoScio()) != null) {
                throw new PreexistingEntityException("Detallefacturaproductoscio " + detallefacturaproductoscio + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
